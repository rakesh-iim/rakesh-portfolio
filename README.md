...
An animated, glassmorphism portfolio built with React, Vite, Framer Motion, and Tailwind CSS — minimal executive aesthetic in emerald + amber.
...
- **Contact** — email, LinkedIn, résumé CTAs
...
- **CSS-only animated backdrop** — drifting blurred orbs, GPU-accelerated
